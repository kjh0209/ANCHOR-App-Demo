...
// Native platforms should load ManualLocationScreen.native.tsx
// Web platform should load ManualLocationScreen.web.tsx
...
export default function ManualLocationScreen({ route, navigation }: any) {
  ...
  const parseTextInput = async () => {
    ...
    try {
      ...
      console.error(error);
      if(Platform.OS === 'web') window.alert('주소 변환에 실패했습니다.');
    } finally {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <Card style={styles.headerCard}>
          <Card.Content>
            <Text variant="titleLarge" style={styles.title}>위치 설정</Text>
